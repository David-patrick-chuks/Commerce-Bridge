...
<head>
  <meta charset="UTF-8">
  <title>${project_name} Dummy Payment</title>
  <style>
...
<body>
  <div class="receipt">
    ...
    <div style="margin-top:24px; color:#555;">Thank you for shopping with ${project_name}!</div>
  </div>
</body>
</html>`);
};
